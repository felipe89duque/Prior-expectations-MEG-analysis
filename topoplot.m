...
%------------------------------------------------------------------------
% Ole Jensen, F.C. Donders Centre for Cognitive Neuroimaging, 
% P.O. Box 9101, NL-6500 HB Nijmegen, The Netherlands        
% Report bugs to ole.jensen@fcdonders.kun.nl  
%------------------------------------------------------------------------

%    Copyright (C) 2002 by Ole Jensen 
...
function handle = topoplot(Vl,p1,v1,p2,v2,p3,v3,p4,v4,p5,v5,p6,v6,p7,v7,p8,v8,p9,v9)
...
[chNum,X,Y,Width,Height,labels] = textread(LAYOUTFILE,'%f %f %f %f %f %s');
...
if ~strcmp(STYLE,'blank')
  ...
  [Xi,Yi,Zi] = griddata(y,x,Vl,yi',xi,'natural'); % 'v4' 'natural' Interpolate data   %griddata(y,x,Vl,yi',xi,'invdist');
